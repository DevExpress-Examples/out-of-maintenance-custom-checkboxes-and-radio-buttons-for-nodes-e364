<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="TreeList_Templates_ClientChecksAndRadios_Default" %>
	...
	<dxwtl:ASPxTreeList ID="ASPxTreeList1" runat="server" AutoGenerateColumns="False"
		...
		<Columns>
			...
			<dxwtl:TreeListDataColumn Caption="Hide" VisibleIndex="1">
				<DataCellTemplate>                    
					<input type="checkbox" <%#IIf(HiddenNodeList.Contains(Container.NodeKey), "checked=""checked""", "")%> 
			...
			<dxwtl:TreeListDataColumn Caption="Start" VisibleIndex="2">
				<DataCellTemplate>
					<input type="radio" name="myradio" value="<%#Container.NodeKey%>" <%#IIf(StartNodeKey = Container.NodeKey, "checked=""checked""", "")%> />
				</DataCellTemplate>
			</dxwtl:TreeListDataColumn>
		</Columns>
	</dxwtl:ASPxTreeList>
